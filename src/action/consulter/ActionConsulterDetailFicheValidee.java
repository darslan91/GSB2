...
public class ActionConsulterDetailFicheValidee implements ActionListener{
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		new Vue_Detail(ModeleConsulter.getId(nom, prenom), mois, ModeleConsulter.getMontantValider(mois, ModeleConsulter.getId(nom, prenom)), this.lesFF, this.lesFHF, "Validée");
